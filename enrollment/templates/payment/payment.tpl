<html>
	...
	<body>
		<nav id="searchStudent">
			<div id="container">
				<a href="/enrollment/templates/cashier/?studentID={$studentID}" class="pull-right"  title="payment">(return)</a>
			...
			<label>transaction date= {$payment[0].transaction_date}</label>
				<a href="/enrollment/logic/payed.php?paymentID={$payment[0].payment_id}" 
