			...
			<form>
				...
				<table class="table table-bordered table-condensed table-striped">
					...
					{foreach from=$result item=details}
						...
						<td style="width: 1px; wrap: nowrap;"><a href='adminEdit.php?user_id={$details.user_id}'
						class="btn btn-success" title="Edit User"> <i class="icon icon-edit"></i>
						</a></td>
						<td style="width: 1px; wrap: nowrap;"><a href='adminDelete.php?user_id={$details.user_id}' 
